...
STATES_OF_INTEREST = ["VT"]         # e.g. ["NC", "TX", ...]
CASE_ID = "202512_res_VT"    # folder suffix for downloads
QUERY_YEAR = 2024
...
FINAL_RESIDENTIAL_CSV = "./VT_final_residential.csv"
...
METADATA_CSV_TEMPLATE = "./residential_data_SELECT_STATES_FILTERED_VT.csv"
