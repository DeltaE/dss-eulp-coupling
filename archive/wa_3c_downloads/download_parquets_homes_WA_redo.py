...
# Match your use case (WA from your link); change as needed
STATES_OF_INTEREST = ["WA"]         # e.g. ["NC", "TX", ...]
CASE_ID = "202512_res_WA"    # folder suffix for downloads
QUERY_YEAR = 2024
...
FINAL_RESIDENTIAL_CSV = "./WA_final_residential.csv"
df_final_comm = pd.read_csv(FINAL_RESIDENTIAL_CSV)
bldg_list_from_csv = df_final_comm["bldg_id"].tolist()
column_selection_case = {
    "State": STATES_OF_INTEREST,
    "bldg_id": bldg_list_from_csv
}
'''
...
METADATA_CSV_TEMPLATE = "./residential_data_SELECT_STATES_FILTERED_WA.csv"
