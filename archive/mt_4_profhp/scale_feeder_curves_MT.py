...
for feeder in relevant_feeders:
    ...
    commercial_merged = commercial_merged.assign(Parquet_Folder="parquet_commercial_202512_comm_MT")
    residential_merged = residential_merged.assign(Parquet_Folder="parquet_residential_short_202512_res_MT")
