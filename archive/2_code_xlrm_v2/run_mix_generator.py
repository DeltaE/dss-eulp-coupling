...
BOUNDS = {
    "ev_perc":           (0.989, 0.99),  # share of customers w/ EVs
    "ev_lvl2_perc":      (0.989, 0.99),  # share of EVs with Level-2 charging
    "storage_perc_3ph":  (0.49, 0.5),  # share of 3-phase customers w/ storage
    "pv_perc_3ph":       (0.24, 0.25),  # share of 3-phase customers w/ PV
}
...
EV_SPLIT_BOUNDS = (0.79, 0.80)  # only used if EV_SPLIT_FIXED=False; controlled in [lo, hi]
...
FIXED_CASE0 = {
    "shares": {"baseline": 0.2, "dm": 0.0, "un": 0.8},
    "heating_seed": SEED0_FIXED,
    "ev_perc": 0.99, "ev_lvl2_perc": 0.99, "ev_seed": SEED0_FIXED,
    "storage_perc_3ph": 0.01, "storage_seed": SEED0_FIXED,
    "pv_perc_3ph": 0.01,      "pv_seed": SEED0_FIXED,
    "disjoint_sets": False,
    # NEW: if omitted, consumer defaults to 50-50; we include it explicitly.
    "ev_split": {"controlled": 0.01, "uncontrolled": 0.99},
}

FIXED_CASE2 = {
    "shares": {"baseline": 1, "dm": 0.0, "un": 0.0},
    "heating_seed": SEED0_FIXED,
    "ev_perc": 0.01, "ev_lvl2_perc": 0.01, "ev_seed": SEED0_FIXED,
    "storage_perc_3ph": 0.01, "storage_seed": SEED0_FIXED,
    "pv_perc_3ph": 0.01,      "pv_seed": SEED0_FIXED,
    "disjoint_sets": False,
    # NEW: if omitted, consumer defaults to 50-50; we include it explicitly.
...
def _make_scenario_dicts_from_unit(U, case_ids, fixed_case0, bounds, ev_split_fixed=True, ev_split_bounds=(0.2,0.8)):
    ...
    '''
    Here we will add the shares of purely managed systems to look at the impact
    '''
    baseline = [0.2]; dm = [0.6]; un = [0.2]
...
if __name__ == "__main__":
    ...
    mixes_lhs = {"0": FIXED_CASE0.copy(), "2":FIXED_CASE2.copy()}
