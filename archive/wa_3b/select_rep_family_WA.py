...
desired_buildings_per_type = {
   "Hospital": 6, #round(0.01*len(unique_com_parquets)),
   "LargeHotel": 11, # round(0.02*len(unique_com_parquets)),
   "SecondarySchool": 10, #round(0.03*len(unique_com_parquets)),
   "LargeOffice": 33, #round(0.04*len(unique_com_parquets)),
   "MediumOffice": 43, #round(0.05*len(unique_com_parquets)),
   "SmallHotel": 21, # round(0.05*len(unique_com_parquets)),
   "PrimarySchool": 9, #round(0.05*len(unique_com_parquets)),
   "QuickServiceRestaurant": 80, #round(0.10*len(unique_com_parquets)),
   "Outpatient": 110, #round(0.05*len(unique_com_parquets)),
   "FullServiceRestaurant": 110, #round(0.05*len(unique_com_parquets)),
   "RetailStandalone": 110, # round(0.15*len(unique_com_parquets)),
   "RetailStripmall": 110, #round(0.10*len(unique_com_parquets)),
   "SmallOffice": 120, #round(0.15*len(unique_com_parquets)),
   "Warehouse": 110 #round(0.15*len(unique_com_parquets)) + 2 # makes dictionary equal to the total
}
...
'''
THIS ONE IS THE VARIABLE THAT NEEDS MODIFICATION
BECAUSE THE TYPES ARE FEWER
ordered_types_res_scenario = [
    "Mobile Home",
    "2 Unit",
    "3 or 4 Unit",
