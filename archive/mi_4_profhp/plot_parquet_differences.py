...
EXTERNAL_FOLDER_STR = 'on_3c_downloads'
...
# Folders to process
folders = [
    Path('..') / EXTERNAL_FOLDER_STR / "parquet_commercial_202512_comm_MI",
    Path('..') / EXTERNAL_FOLDER_STR / "parquet_residential_short_202512_res_MI"
]
