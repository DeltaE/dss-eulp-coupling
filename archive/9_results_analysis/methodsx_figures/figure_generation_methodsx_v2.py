...
def figure_b(match_df):
    ...
    # Total commercial loads per state (matched + unmatched)
    total_com = 883  # from SMART-DS (identical across states)
    ...
    for state in STATES_ORDER:
        ...
        # "No match" = total commercial loads minus those with valid tolerance
        n_matched = int(matched.notna().sum())
        counts[state].append(total_com - n_matched)
