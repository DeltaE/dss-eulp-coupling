...
STATE_STR = 'MT'  # Closest to Alberta (AB)
...
df_com_ALL = pd.read_csv("../commercial_data_SELECT_STATES_MI_MT_VT_WA.csv")
df_res_ALL = pd.read_csv("../residential_data_SELECT_STATES_MI_MT_VT_WA.csv")
