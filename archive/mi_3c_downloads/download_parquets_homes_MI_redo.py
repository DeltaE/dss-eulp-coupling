...
STATES_OF_INTEREST = ["MI"]         # e.g. ["NC", "TX", ...]
CASE_ID = "202512_res_MI"    # folder suffix for downloads
QUERY_YEAR = 2024
...
FINAL_RESIDENTIAL_CSV = "./MI_final_residential.csv"
...
METADATA_CSV_TEMPLATE = "./residential_data_SELECT_STATES_FILTERED_MI.csv"
