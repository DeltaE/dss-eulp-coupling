...
STATES_OF_INTEREST = ["MT"]         # e.g. ["NC", "TX", ...]
CASE_ID = "202512_res_MT"    # folder suffix for downloads
QUERY_YEAR = 2024
...
FINAL_RESIDENTIAL_CSV = "./MT_final_residential.csv"
...
METADATA_CSV_TEMPLATE = "./residential_data_SELECT_STATES_FILTERED_MT.csv"
