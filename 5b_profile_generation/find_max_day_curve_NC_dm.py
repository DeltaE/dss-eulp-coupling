...
SCENARIO = "dm"                # daily_parquets suffix so baseline/dm/uncontrolled don't overwrite each other
...
df_summary_result = pd.read_csv(
    os.path.join(CONTROL_OUTPUT_DIR, STR_STATE + "_required_parquets_per_feeder_dm.csv")
)
